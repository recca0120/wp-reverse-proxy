...
class ReverseProxyTest extends TestCase
{
    ...
    public function test_it_removes_brotli_from_accept_encoding()
    {
        $this->mockClient->addResponse(new Response(200, [], '{}'));
        ...
        $lastRequest = $this->mockClient->getLastRequest();
        $this->assertEquals('gzip, deflate', $lastRequest->getHeaderLine('Accept-Encoding'));
    }

    public function test_it_removes_brotli_when_only_br()
    {
        $this->mockClient->addResponse(new Response(200, [], '{}'));
        ...
        $lastRequest = $this->mockClient->getLastRequest();
        $this->assertFalse($lastRequest->hasHeader('Accept-Encoding'));
    }

    public function test_it_preserves_accept_encoding_without_br()
    {
        $this->mockClient->addResponse(new Response(200, [], '{}'));
    ...
    public function test_it_does_not_add_accept_encoding_when_not_present()
    {
        $this->mockClient->addResponse(new Response(200, [], '{}'));
